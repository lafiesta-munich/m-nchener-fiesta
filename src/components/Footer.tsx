              ...
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <a
                    ...
                    className="text-primary-foreground/70 hover:text-primary transition-colors duration-300 cursor-pointer"
                  >
                    {link.label}
                  </a>
                </li>
      ...
      <div className="border-t border-primary-foreground/10">
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-primary-foreground/50">
            <p>
              © {new Date().getFullYear()} La Fiesta München. Alle Rechte
              vorbehalten.
            </p>
